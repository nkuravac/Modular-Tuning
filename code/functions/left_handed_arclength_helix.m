function [flagellum,UIB] = left_handed_arclength_helix(phase,freq,blob_size_on_flag,R,wave_length,arclen,dir)
    %R = 0.2;
    ...
    %%%%%compute axial length given arclength
    %%arclength
    ...
    findbound = @(b) integral(f,0,b)-arclen;
    Ls = fzero(findbound,0);
