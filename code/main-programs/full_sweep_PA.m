...
bigdir ='../../data/new_ineff_arclen_sweep_PA'; %,char(datetime('now','Format','MM-dd-yyyy_HH-mm'))
rawdir=[bigdir,'/raw'];
...
arclen_array=linspace(r,30*r,59);
...
arclen_array=sort([arclen_array,opt_arclen_purcell,L_Wu]); %,L_Wu
wave_length_array=[opt_wl_purcell,p_Wu];
hrad_array=[opt_hrad_purcell,R_Wu];
...
writetable(full_sweep_table,[summarydir,'/arclen_sweep_table_PA_new_opt_ineff.txt']);
